...
function initGetProvider(providers) {
  return function getProvider2({ service: service2, success, fail, complete }) {
    let res;
    if (providers[service2]) {
      res = {
        errMsg: "getProvider:ok",
        service: service2,
        provider: providers[service2]
      };
      isFunction(success) && success(res);
    } else {
      res = {
        errMsg: "getProvider:fail:服务[" + service2 + "]不存在"
      };
...
function renderComponentRoot(instance) {
  ...
  try {
    if (vnode.shapeFlag & 4) {
      ...
      result = render2.length > 1 ? render2(props, { attrs, slots, emit: emit22 }) : render2(
        props,
        null
...
(function(exports2) {
  ...
  var b642 = new Array(64);
  var s64 = new Array(123);
  for (var i2 = 0; i2 < 64; )
    s64[b642[i2] = i2 < 26 ? i2 + 65 : i2 < 52 ? i2 + 71 : i2 < 62 ? i2 - 4 : i2 - 59 | 43] = i2++;
...
var pool_1 = pool;
function pool(alloc2, slice, size2) {
  var SIZE = size2 || 8192;
  var MAX = SIZE >>> 1;
  var slab = null;
  var offset = SIZE;
